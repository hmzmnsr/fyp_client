...
const Admission = () => {
    return (
        <div className="mx-20 my-10 px-10 py-10 bg-gray-200 drop-shadow-2xl">
            ...
            <div className="flex justify-center items-center"><a href="https://usa.edu.pk/apply-now/" target="_blank" rel="noopener noreferrer"><button className="px-16 py-5 bg-primary-color text-white rounded-full hover:bg-red-700 transition duration-300 ease-in-out text-lg">Get Started</button></a></div>
        </div>
    )
}
