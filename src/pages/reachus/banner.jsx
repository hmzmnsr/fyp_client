...
import banner from "../../assets/reachus/banner.jpg";
...
const ReachBanner = () => {
  ...
  return (
    <div className="overflow-hidden">
      <div
        className={`relative transform transition-transform duration-500 ${isVisible ? "translate-x-0" : "translate-x-full opacity-0"
          }`}
      >
          ...
          <div className="absolute inset-0 flex justify-start items-center pr-10 z-10 h-screen ml-40">
            <div className="text-center bg-primary-color w-28 h-3/6">
              <div className="text-8xl text-white font-semibold py-4 px-6">
                Computer Science Department's ContactUs
              </div>
